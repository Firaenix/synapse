 ...
 */
export const PaymentChannelCast = {
  /**
   * P2MS lockingScript
   *
  ...
  unlockingScript: {
    script: [
      ...
      // 2. Sigs
      function (ctx, { keyPairs, sighashType = Sig.SIGHASH_ALL | Sig.SIGHASH_FORKID, flags = Tx.SCRIPT_ENABLE_SIGHASH_FORKID }) {
